...
* 2. [1. Cloud Native - developing for the cloud](#CloudNative-developingforthecloud)
* 3. [The Basics - What is a REST API and why developers use REST APIs](#TheBasics-WhatisaRESTAPIandwhydevelopersuseRESTAPIs)
* 4. [Developing the API](#DevelopingtheAPI)
	* 4.1. [Creating a REST API Template](#CreatingaRESTAPITemplate)
	* 4.2. [Adding Language Processing Libraries](#AddingLanguageProcessingLibraries)
* 5. [Deploying the API](#DeployingtheAPI)
	* 5.1. [Building the Container Image](#BuildingtheContainerImage)
	* 5.2. [Deploying the Container Image](#DeployingtheContainerImage)
* 6. [Putting it into Practice](#PuttingitintoPractice)
	* 6.1. [Example Texts](#ExampleTexts)
	* 6.2. [Invocation via WebUI](#InvocationviaWebUI)
	* 6.3. [Invocation of the API via PowerShell on your machine](#InvocationoftheAPIviaPowerShellonyourmachine)
* 7. [Challenges](#Challenges)
	* 7.1. [Challenge 1](#Challenge1)
	* 7.2. [Challenge 2](#Challenge2)
	* 7.3. [Challenge 3](#Challenge3)
	* 7.4. [Following Challenges - Prerequisites](#FollowingChallenges-Prerequisites)
	* 7.5. [Challenge 4](#Challenge4)
...
##  3. <a name='TheBasics-WhatisaRESTAPIandwhydevelopersuseRESTAPIs'></a>The Basics - What is a REST API and why developers use REST APIs
...
##  4. <a name='DevelopingtheAPI'></a>Developing the API

The API will be developed using Python - one of the most popular multi-purpose programming languages.

###  4.1. <a name='CreatingaRESTAPITemplate'></a>Creating a REST API Template
...
###  4.2. <a name='AddingLanguageProcessingLibraries'></a>Adding Language Processing Libraries
...
##  5. <a name='DeployingtheAPI'></a>Deploying the API
...
###  5.1. <a name='BuildingtheContainerImage'></a>Building the Container Image
...
###  5.2. <a name='DeployingtheContainerImage'></a>Deploying the Container Image
...
##  6. <a name='PuttingitintoPractice'></a>Putting it into Practice


###  6.1. <a name='ExampleTexts'></a>Example Texts
...
###  6.2. <a name='InvocationviaWebUI'></a>Invocation via WebUI
...
###  6.3. <a name='InvocationoftheAPIviaPowerShellonyourmachine'></a>Invocation of the API via PowerShell on your machine
...
###  7.1. <a name='Challenge1'></a>Challenge 1
...
###  7.2. <a name='Challenge2'></a>Challenge 2
...
###  7.3. <a name='Challenge3'></a>Challenge 3
...
###  7.4. <a name='FollowingChallenges-Prerequisites'></a>Following Challenges - Prerequisites
...
###  7.5. <a name='Challenge4'></a>Challenge 4
